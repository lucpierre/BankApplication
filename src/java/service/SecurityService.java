...
public class SecurityService {
    ...
    public SecurityService(){
        ...
        ROUTING_MAP.put("remove_client_account_get", new ArrayList(Arrays.asList(advisor)));
        ROUTING_MAP.put("add_client_account_get", new ArrayList(Arrays.asList(advisor)));
        ROUTING_MAP.put("add_client_account_post", new ArrayList(Arrays.asList(advisor)));
